...
const Discover = () => {
    ...
    const topicStyle = "xl:border-2 hover:bg-primary xl:border-gray px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-black"
